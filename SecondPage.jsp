<%-- 
    Document   : SecondPage
    Created on : Apr 16, 2022, 5:43:14 PM
    Author     : hkhar
--%>
...
<!--                        <li class="nav-item">
    ...
    <div class="welCome">
      <h1 class="font1">WELCOME TO LAUNDRY SERVICE....</h1>
        ...
        <form action="malecart" method="post"> 
        <section id ="ClothcartmaleUser">
                        ...
                        <table id="myTable" class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" value="8" class="price form-control" disabled>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" value="9" class="price form-control" disabled>
                                    </td>
                                    <td align="right">Rs<span id="amount" class="amount">0</span>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="button-container">
                                            <button class="cart-qty-plus" type="button" value="+">+</button>
                                            <input type="text" name="p5" min="0" class="qty form-control" value="0"/>
                                            <button class="cart-qty-minus" type="button" value="-">-</button>
                                        </div>
                                    </td>
                                    <td>
                                        <input type="text" value="15" class="price form-control" disabled>
                                    </td>
                                    <td align="right">Rs<span id="amount" class="amount">0</span>
                                    </td>
                                </tr>
